	...
	return (
		<div>
				...
				<div className="max-w-7xl mx-auto py-2 px-3 sm:px-6 lg:px-8">
					<div className="pr-16 sm:text-center sm:px-16">
						<p className="font-medium text-white">
							<span className="md:hidden">Are you excited to use this application!</span>
							<span className="hidden md:inline">
								Big news! Are you excited to use this application!. {/*We&apos;re = we're*/}
							</span>
			...
			<div className="flex min-h-screen flex-col justify-between py-5 ">
				...
				<main className="container m-auto mt-4 md:mx-8 md:pb-7 ">{children}</main>

				<footer className="bg-white shadow-inner">
					<div className="h-10 mx-auto py-8 px-4 sm:px-6 md:flex   md:items-center md:justify-between  lg:px-8">
						<div className="flex justify-center space-x-6 md:order-3 pb-5">
							{navigation.map((item) => (
