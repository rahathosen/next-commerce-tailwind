...
export default function Hero() {
  return (
    <div className="sm:py-30 relative mx-auto flex max-w-3xl flex-col items-center py-32 px-6 text-center lg:px-0">
      <h1 className="text-4xl font-extrabold tracking-tight text-gray-500 lg:text-6xl">
      ...
      <a
        href="#"
        className="mt-8 inline-block rounded-md border border-transparent bg-gray-200 py-3 px-8 text-base font-medium text-gray-900 hover:bg-gray-300"
      >
        Shop New Arrivals
      </a>
    </div>
