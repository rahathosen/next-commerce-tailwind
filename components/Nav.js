                    ...
                    <div className="">
                      <form>
                        <input
                          ...
                          name="search"
                          placeholder="search"
                          className="w-[85px] border border-t-0 border-r-0 border-l-0 bg-white px-4  py-3 text-gray-800 duration-500  focus:w-full focus:border-t-0 focus:border-r-0 focus:border-l-0 focus:border-gray-600 
